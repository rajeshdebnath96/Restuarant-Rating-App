...
public class SortByName {
    ...
    public SortByName(ListViewController listViewController,String area, String foodType){
    ...
    private void sortByRating() {
        ...
        if ((area.equals("All") || area.equals("NA")) && (foodtype.equals("NA")||foodtype.equals("All"))) {
            query = "select * from foodiesDhaka order by name";
            System.out.println(query);
        }
        else if ((foodtype.equals("NA")||foodtype.equals("All")) && !(area.equals("All") || area.equals("NA"))) {
            query = "select * from foodiesDhaka where area='" + area + "'order by name";
            System.out.println(query);
        }
        else if(!(foodtype.equals("NA")||foodtype.equals("All")) && (area.equals("All") || area.equals("NA"))){
            query = "select * from foodiesDhaka where foodType like '" + foodtype + "%' OR " + "'%" + foodtype + "' order by name";
            System.out.println(query);
        }
        else{
            query = "select * from foodiesDhaka where area='"+area+"' AND foodType like '" + foodtype + "%' OR " + "'%" + foodtype + "' order by name";
            System.out.println(query);
        }
